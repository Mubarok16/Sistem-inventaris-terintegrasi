...
<div x-data="{ selectedBarang: {} }" class=" mb-4">
    <form action="{{ route('cari_barang') }}" method="post">
                ...
                @foreach ($dataTablePengajuanPeminjaman as $dataBarang)
                    ...
                    <article
                        ...
                        <div class="px-3 py-3 flex flex-col gap-2">
                            ...
                            <span class="text-xs font-medium text-slate-400 uppercase tracking-wide">Tempat: Ruang
                                {{ $dataBarang->nama_room != null ? $dataBarang->nama_room : 'tidak diketahui' }}
                            </span>
                            </span>
