    ...
    <main class="layout-container flex grow flex-col items-center justify-center mb-4 px-0 sm:px-8 lg:px-20">
        <div class="w-full max-w-[1200px] flex flex-col gap-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
                @foreach ($dataTablePengajuanPeminjaman as $dataRuangan)
                    <!-- Product Card 1 -->
                    <article
                        ...
                        <div class="px-3 py-3 flex flex-col gap-2">
                            <div class="flex items-center justify-between">
                                <span
                                    class="text-xs font-medium text-slate-400 uppercase tracking-wide">{{ $dataRuangan->nama_tipe_room }}</span>
                                <div class="flex items-center gap-1 text-green-500">
                                    <span
                                        class="material-symbols-outlined text-[16px] leading-none">{{ $dataRuangan->kondisi_room }}</span>
                            ...
                            <div class="flex items-center justify-between mt-auto pt-2">
                                <div class="flex gap-2 w-full">
                                    <form action="{{ route('mhs-detail-peminjaman-ruang', $dataRuangan->id_room) }}"
