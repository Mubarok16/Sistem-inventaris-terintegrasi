    ...
    <div class="flex-1 flex flex-col ">
        <main class="flex-1 p-6 lg:px-4 lg:py-2 max-w-7xl">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="stat-card bg-white p-6 border border-border-light rounded-xl">
                    <div class="flex justify-between items-start mb-4">
                        <div class="size-10 bg-amber-50 text-amber-500 rounded-lg flex items-center justify-center">
                            <i class="fa-solid fa-star"></i>
                        </div>
                        <span class="text-[10px] font-bold text-amber-600 bg-amber-50 px-2 py-1 rounded">Populer</span>
                    </div>
                    <p class="text-text-muted text-xs font-bold uppercase tracking-wider">Aset Terpopuler</p>
                    <h3 class="text-xl font-bold text-text-main mt-1">Lab. Komputer 03</h3>
                    <div class="flex -space-x-2 mt-4">
                        <div class="size-7 rounded-full border-2 border-white bg-slate-200 bg-cover"
                            style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuCPrYoo_iYwCs7I894gbXV3_HFNAwqNoC8f4DYMwyhr4bblHJK_GpgwZGo1lL6m8v33ADlYk16EMpeQybvwN5ZSU-IHZ9fkB-EgY0uJOPq3_ByBgSJpJQPu-DbmuGTX58viv7KB3Higplzve4gb_BNfDS5fmlBsx9uIO5EFalXmmS2N8Vg0L6NC3kdnsMO7CdP-2Pv0ozLY_mlea2-IWi9vXtR7JPSntyUYo-2INlRbTAk7rHz7LUdRBSuwqwyyvzIpF1kZ9kNiqN4')">
                        </div>
                        <div class="size-7 rounded-full border-2 border-white bg-slate-200 bg-cover"
                            style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuBe-U5EfnhWagAYwK0NGzgrjdhF3hJpHPIFwQIpDxVvQvdgT8LZJlKYywOODjI-1rwkw6IV2TXBjaFKVoeV1mNAddr_FG3YvvuxzlIPFaHlCS9BQGrLZ2yIE2YEjTKW4_evhSQWzZqd7zF9lb0Vo_OrAp6aD-XmaokEkZBhdXBdU3P7xUWqiZ778HJ8av06J4feif8eYvJ9GV23DTL5ppNX_TOozoJwLnCDQwhsTyGCxqn_tUIA65_c3GMlmi5vgiwzuRSsCfmDJoM')">
                        </div>
                        <div class="size-7 rounded-full border-2 border-white bg-slate-200 bg-cover"
                            style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuBqTvsRmE25-u5-1x71q-0YVzq8zd4nxgLSqL2MOmvz3n19ct7qwAeqHj_TrNOfQdKYGcyjwBn4zQw0OdLBZ0ySSiq1l9JxkcAjsflAvP_Qy8ck4x6nI74NBz10AJUXDh8wJkX5oMXvtDJEh1c8SIcljqgvkV0RqH-_hoZiLrax6uHS9oDJPbIHwpZF1mpbBSo7PmzJNzlTJg3-LWNbgKw52YeQijZrX2Ps0gDdnPHFj0OyMu4al1GhPceEKZ_Ke5Y0vVCyHqXbJPo')">
                        </div>
                        <div
                            class="size-7 rounded-full border-2 border-white bg-slate-100 flex items-center justify-center text-[8px] font-bold text-slate-500">
                            +12</div>
                    </div>
                </div>
                <div class="stat-card bg-white p-6 border border-border-light rounded-xl">
